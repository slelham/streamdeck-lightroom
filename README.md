...
**Current version: 1.3.1** — after install, the Connection key icon shows `v1.3.1` at the bottom, and the title should read `v1.3.1 Online`. Run `./scripts/verify-install.sh` to confirm.
